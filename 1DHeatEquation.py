...
if __name__ == "__main__":
    n_elements = 32
    # Giving each interval the same length
    ...
    # x[0] - potentially we might have more than 1D space
    ...
    # The forcing of the rhs of the PDE
    ...
    weak_form_residuum = (
        ...
        u_old * v_test * fe.dx
        +
        time_step_length * diffusivity * fe.dot(fe.grad(u_trial), fe.grad(v_test)) * fe.dx
    )
